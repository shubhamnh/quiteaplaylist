<template>
    <div class="flex flex-col min-h-screen bg-blue-gray-050 text-blue-gray-900">
        <div class="flex flex-row items-center bg-white shadow-sm">
            <ul class="flex flex-row flex-grow justify-between items-center mx-5 my-3">
                ...
                <div class="flex flex-row gap-2 sm:gap-5">
                    <li class="relative group">
                        <router-link to="/guide" v-slot="{ isActive }" class="px-1 sm:px-2 py-2 font-semibold" title="Guide">
        ...
        <div class="py-3 text-center text-sm text-gray-600">
            <span>Powered by <a class="hover:underline " href="https://archive.org/" target="_blank" title="Internet Archive">Internet Archive</a></span>
